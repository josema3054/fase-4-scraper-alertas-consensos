...
echo    4. PROBAR SCRAPER CON SELENIUM (ROBUSTO)
echo    5. CONFIGURACION DEL SISTEMA
echo    6. VER ESTADO DEL SISTEMA
echo    7. REINICIAR CACHE DE LA APLICACION
echo    8. SALIR
echo.
echo    ========================================================
...
if %choice%==4 goto test_selenium
if %choice%==5 goto configurar
if %choice%==6 goto estado
if %choice%==7 goto reiniciar_cache
...
cls
echo.
echo    PROBAR SCRAPER CON SELENIUM (ROBUSTO)
echo    ========================================================
echo.
echo    Selenium abre un navegador real para obtener los datos
echo    Es mas lento pero siempre funciona
echo    Se instalara automaticamente si es necesario
echo.
echo    Ejecutando configuracion e instalacion de Selenium...
python setup_selenium.py
echo.
echo    Ejecutando scraper Selenium...
python selenium_scraper.py
echo.
echo    ========================================================
echo    El scraper Selenium es mas lento pero mas confiable
echo.
pause
goto inicio
